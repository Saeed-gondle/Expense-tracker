...
export default class Email {
  ...
  async sendWelcome() {
    await this.send('welcome', 'Welcome to the Expense Tracker App!');
  }
  ...
  async sendMonthlySummary(totalSpent, topCategory, budgetStatus) {
    // Add more data to the template
    this.totalSpent = totalSpent;
    this.topCategory = topCategory;
    this.budgetStatus = budgetStatus;

    await this.send('monthlySummary', 'Your Monthly Expense Summary');
  }
}
